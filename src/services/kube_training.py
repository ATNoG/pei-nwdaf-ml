    ...
    def to_kube(self, model_id: str, job_id: str, resources: JobResources | None, training_type: str):
        spec = JobSpec(
            ...
            env={
                ...
                "DATABASE_URL": settings.TRAIN_KUBE_DB_URL or settings.DATABASE_URL,
                "MLFLOW_TRACKING_URI": settings.TRAIN_KUBE_MLFLOW_URI or settings.MLFLOW_TRACKING_URI,
                "MLFLOW_S3_ENDPOINT_URL": settings.TRAIN_KUBE_MLFLOW_S3 or settings.MLFLOW_S3_ENDPOINT_URL,
                "AWS_ACCESS_KEY_ID": settings.AWS_ACCESS_KEY_ID,
                "AWS_SECRET_ACCESS_KEY": settings.AWS_SECRET_ACCESS_KEY,
                "AWS_DEFAULT_REGION": settings.AWS_DEFAULT_REGION,
                "DATA_STORAGE_API_URL": settings.TRAIN_KUBE_DATA_STORAGE_URL or settings.DATA_STORAGE_API_URL,
